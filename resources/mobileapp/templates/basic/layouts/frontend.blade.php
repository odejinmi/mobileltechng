...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <!-- aos css -->
    <link rel="stylesheet" type="text/css" href="{{ asset($activeTemplateTrue . 'mobile/css/vendors/aos.css') }}" />
...
<body>
    ...
    <!-- aos js -->
    <script src="{{ asset($activeTemplateTrue . 'mobile/js/aos.js') }}"></script>
    <script src="{{ asset($activeTemplateTrue . 'mobile/js/init-aos.js') }}"></script>

    <!-- bootstrap js -->
    <script src="{{ asset($activeTemplateTrue . 'mobile/js/bootstrap.bundle.min.js') }}"></script>

    <!-- onload rocket -->
    <script src="{{ asset($activeTemplateTrue . 'mobile/js/onload.js') }}"></script>
