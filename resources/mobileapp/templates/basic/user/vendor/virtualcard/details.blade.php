    ...
    <div class="custom-container">
      <ul class="card-list">
        <li class="credit-card-box color1">
          <div class="card-logo">
            <h4 class="card-name">{{@$reply['data']['brand']}}</h4>
            <div class="dropdown">
              <a role="button" >
          ...
          <div class="d-flex align-items-center justify-content-between">
            <div>
              <h6 class="card-number"><b>Card Pan:</b>{{$reply['data']['pan']}}</h6>
              <h5 class="card-name"><b>PIN:</b> {{ strToUpper($reply['data']['pin']) }}</h5>
            </div>
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="card-date w-100">
              <h6>Exp. date</h6>
              <h6 class="text-white fw-semibold mt-1">{{$reply['data']['expiry_month']}}/{{$reply['data']['expiry_year']}}</h6>
            </div>
            <div class="card-numbers w-100">
              <h6 class="cvv-code">CVV</h6>
              <h6 class="text-white fw-semibold mt-1">{{$reply['data']['cvv']}}</h6>
            </div>
          </div>
        </li>
        ...
        @if ($reply['data']['status'] == 'active')
             ...
             {{--
              ...
              --}}
              <a  data-bs-toggle="modal" data-bs-target="#pin-modal" data-bs-whatever="@getbootstrap" href="#" class="btn btn-primary btn-sm"><i class="ti ti-key"></i> @lang('Pin')</a>
