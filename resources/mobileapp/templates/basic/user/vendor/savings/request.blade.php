...
@section('panel')
              ...
              <div class="swiper banner">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="#">
                      <img class="img-fluid banner-img" src="{{ asset($activeTemplateTrue . 'mobile/images/banner/savings1.png')}}" alt="banner1" />
                    </a>
                  </div>
        
                  <div class="swiper-slide">
                    <a href="#">
                        <img class="img-fluid banner-img" src="{{ asset($activeTemplateTrue . 'mobile/images/banner/savings2.png')}}" alt="banner1" />
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="custom-container">
                    ...
                    <div class="profile-pic">
                        <img class="img-fluid pay-img"
                            src="{{ asset($activeTemplateTrue . 'mobile/images/gif/successfull-payment.gif') }}"
                            alt="Payment" />
                    </div>
                    <h3 class="person-name">Paying money to {{ auth::user()->username }}</h3>
                ...
                <div class="custom-container">
                    ...
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" value="{{ old('ramount') }}" name="ramount" placeholder="0.00"
                    ...
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" value="{{ old('ramount') }}" name="tamount" placeholder="0.00"
                                class="form-control" id="inputamount" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" onkeyup="fixeamount(this)" value="{{ old('recurrent') }}" name="recurrent"
                ...
                <div class="custom-container">
                    ...
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" value="{{ old('tamount') }}" name="tamount" placeholder="0.00"
                    ...
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" value="{{ old('recurrentt') }}" name="recurrentt" placeholder="0"
                ...
                <div class="custom-container">
                    ...
                    <div class="form-group">
                        <div class="form-input mt-4">
                            ...
                            <input type="number" value="{{ old('famount') }}" name="famount" placeholder="0.00"
                                class="form-control" id="tamount" />
                        </div>
                    </div>
                    ...
                    <ul class="card-list">
                        @forelse ($plans as $data)
                            <li class="payment-add-box">
                                ...
                                <div class="add-content">
                                    <div>
                                        <h5 class="fw-semibold dark-text">{{ $data->name }}</h5>
                                        <h6 class="mt-2 light-text"></h6>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="plan"
                                            id="reason{{ $data->id }}" value="{{ $data->id }}" checked>
                                    </div>
                                </div>
                            </li>
                        @empty
    ...
    <a href="{{ route('user.savings.history') }}" class="back-btn">
