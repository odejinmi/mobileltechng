          ...
          <a href="#transaction-detail{{$deposit->id}}" data-bs-toggle="modal" class="d-flex gap-3">
            ...
            <div class="transaction-details">
              ...
              <div class="d-flex justify-content-between">
                <h5 class="light-text">{{ __($deposit->product_logo) }}</h5>
      ...
      <div class="modal-body">
        <ul class="details-list">
          <li>
            ...
            <h3 class="fw-normal light-text"><label class='badge @if($deposit->status == 'delivered') bg-success  @else  bg-danger @endif'>@php echo $deposit->status @endphp</label></h3>
          </li>
          <li>
          ...
          <li>
            ...
            <h3 class="fw-normal light-text"> <a href="{{ __($deposit->val_2) }}">
          ...
          <li>
            ...
            <h3 class="fw-normal light-text">{!!$deposit->val_3!!}</h3>
          </li>  
          <li class="amount">
...
<a href="{{ route('user.buy.insurance') }}" class="back-btn">
    <i class="icon" data-feather="x"></i>
  </a>
@endpush