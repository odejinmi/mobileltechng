...
@section('panel')
    ...
    <section class="section-b-space">
        <div class="custom-container">
            <div class="title">
                <h4>Select Wallet</h4>
                <a href="{{ route('user.internet_sme.history') }}">See all</a>
            ...
            <form class="auth-form p-0" method="post">
                                        ...
                                        if (plan['network'] == name) {
                                            ...
                                            <div class="transaction-box">
                                                <a href="#" class="d-flex gap-3">
                                                    ...
                                                    <div class="transaction-details">
                                                        <div class="transaction-name pb-0">
                                                            <h5>${plan['displayName']} <br>
                                                               <small> ${plan['price']}NGN</small>
                                                            </h5>
                                                            <h5 class="dark-text fw-semibold">
                                                                <div class="option d-block mt-3">
                                                                    <div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label" for="${plan['value']}"></label>
                                                                    </div>
                                                                </div>
                                                            </h5>
                                                        </div>
                ...
                <!--begin::Input group-->
                <div class="form-group">
                    <label for="amount" class="form-label">@lang('Select Plan')</label>
                    <!--begin::Fixed Amount-->
