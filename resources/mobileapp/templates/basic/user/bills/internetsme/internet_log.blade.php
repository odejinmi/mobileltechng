          ...
          <a href="#transaction-detail{{$deposit->id}}" data-bs-toggle="modal" class="d-flex gap-3">
            ...
            <div class="transaction-details">
              <div class="transaction-name">
                ...
                <h3 class="success-color"> {{ __($general->cur_sym) }}{{ showAmount($deposit->payment) }}<span></span></h3>
              </div>
              <div class="d-flex justify-content-between">
                <h5 class="light-text">{{$deposit->val_2}}</h5>
      ...
      <div class="modal-body">
        <ul class="details-list">
          <li>
            ...
            <h3 class="fw-normal light-text"><label class='badge bg-success'> {{$deposit->status}}</label></h3>
          </li>
          <li>
          ...
          <li>
            ...
            <h3 class="fw-normal light-text">{{ __($deposit->val_2) }}</h3>
          </li> 
          <li>
            <h3 class="fw-normal dark-text">Network</h3>
            <h3 class="fw-normal light-text">{{ @$deposit->product_name }}</h3>
          </li>  
          <li>
            <h3 class="fw-normal dark-text">Phone</h3>
            <h3 class="fw-normal light-text">{{ @$deposit->val_1 }}</h3>
          </li>    
          <li class="amount">
            <h3 class="fw-normal dark-text">Amount</h3>
            <h3 class="fw-semibold error-color">{{ __($general->cur_text) }} {{ showAmount($deposit->payment) }}</h3>
          </li>
        </ul>
      </div>
