...
<div class="auth-header"style="background-color:#30003D;">
  ...
  <!-- login section start -->
  <form class="auth-form" method="POST" action="{{ route('user.verify.mobile') }}">
    @csrf 
    <div class="custom-container">
      ...
      <h4 class="signup">Haven’t received yet ?<a href="{{ route('user.send.verify.code', 'sms') }}"> Resend it </a></h4>
    </div>
  </form>
  <!-- login section start -->
