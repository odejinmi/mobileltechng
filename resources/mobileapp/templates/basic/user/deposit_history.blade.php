            ...
            <a href="#transaction-detail{{$deposit->id}}" data-bs-toggle="modal" class="d-flex gap-3">
              ...
              <div class="transaction-details">
                <div class="transaction-name">
                  ...
                  <h3 class="@if ($deposit->status == Status::PAYMENT_SUCCESS) success-color @else error-color @endif"> {{ __($general->cur_sym) }}{{ showAmount($deposit->payment) }}<span></span></h3>
                </div>
                <div class="d-flex justify-content-between">
                  <h5 class="light-text">{{ __($deposit->gateway?->name) }}</h5>
        ...
        <div class="modal-body">
          <ul class="details-list">
            <li>
              ...
              <h3 class="fw-normal light-text"> @php echo $deposit->statusBadge @endphp</h3>
            </li>
            <li>
            ...
            <li>
              ...
              <h3 class="fw-normal light-text">{{ __($general->cur_sym) }}{{ showAmount($deposit->amount) }}</h3>
            </li> 
            <li>
              <h3 class="fw-normal dark-text">Fee</h3>
              <h3 class="fw-normal light-text">{{ __($general->cur_sym) }}{{ showAmount($deposit->charge) }}</h3>
            </li>  
            <li>
            ...
            <li>
              ...
              <h3 class="fw-normal light-text">{{ showAmount($deposit->final_amo) }}
