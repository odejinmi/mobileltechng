    ...
    <div class="swiper banner">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="#">
            <img class="img-fluid banner-img" src="{{ asset($activeTemplateTrue . 'mobile/images/banner/banking-business-facebook-template_23-2150956238.jpeg')}}" alt="banner1" />
          </a>
        </div>

        <div class="swiper-slide">
          <a href="#">
            <img class="img-fluid banner-img" src="{{ asset($activeTemplateTrue . 'mobile/images/banner/banking-business-facebook-template_23-2150956238.jpeg')}}" alt="banner2" />
          </a>
        </div>
      </div>
    </div>
...
<section class="section-b-space">
    <div class="custom-container">
      ...
      <ul class="select-bank">
        ...
        <div class="form-group mb-3">
            <label class="form-label" data-kt-translate="two-step-label">@lang('Account Number')</label>
            <input type="text" onkeyup="validatebank()"  class="form-control @error('account') is-invalid @enderror" id="account" name="account" value="{{ old('account') }}" placeholder="Please enter NUBAN account number" />
        </div>
              ...
              <ul class="nav nav-pills tab-style3 w-100 mt-3" id="myTab" role="tablist">
                  <li class="nav-item w-25"  onclick="setamount(500)" role="presentation">
                      <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                          type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">{{$general->cur_sym}}500</button>
                  </li>
         ...
         @endpush
          ...
          <div class="form-group">
              <div class="form-input mt-3">
                <input type="text"
                class="form-control reason @error('narration') is-invalid @enderror"
