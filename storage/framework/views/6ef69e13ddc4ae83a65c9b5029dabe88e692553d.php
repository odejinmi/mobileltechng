 ...
 <form method="POST" action="<?php echo e(route('user.crypto.sellall',encrypt($coin->id))); ?>" enctype="multipart/form-data">
  ...
  <div class="modal add-money-modal fade" id="sell-coin" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title"><?php echo app('translator')->get('Sell All'); ?> <?php echo e($coin->name); ?></h2>
        </div>
        <div class="modal-body">
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/wallet/wallet.blade.php ENDPATH**/ ?>