    ...
    <section class="section-b-space">
        <div class="custom-container">
            ...
            <form class="auth-form p-0" method="post">
                ...
                <button type="button" class="btn theme-btn w-100" onclick="submitform()" id="submit">Proceed</button>
            </form>
        </div>
    </section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/bills/internetsme/internet_buy_NATKEMDATA.blade.php ENDPATH**/ ?>