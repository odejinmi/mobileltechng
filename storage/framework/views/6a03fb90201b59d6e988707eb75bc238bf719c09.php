    ...
    <div class="offcanvas-body">
      <div class="sidebar-content">
        <ul class="link-section">
          ...
          <li>
            <a href="<?php echo e(route('user.pos.transactions')); ?>" class="pages">
              <i class="sidebar-icon" data-feather="printer"></i>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/layouts/dashboard.blade.php ENDPATH**/ ?>