  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title">Airtime Detail</h2>
      </div>
      <div class="modal-body">
        <ul class="details-list">
          ...
          <li>
            <h3 class="fw-normal dark-text">Decoder</h3>
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/bills/cabletv/cabletv_log.blade.php ENDPATH**/ ?>