            ...
            <form class="auth-form p-0" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="country" class="form-select form-select-solid" data-control="select2" id="youSendCurrency"
                        data-hide-search="false" onchange="populate()" data-placeholder="<?php echo app('translator')->get('Select Provider'); ?>">
                        ...
                        <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-decoder="<?php echo e($data['serviceID']); ?>">
                                <?php echo e(strToUpper($data['description'])); ?></option>
                                                                                ...
                                                                                <h5 class="dark-text fw-semibold">
                                                                                    <div class="option d-block mt-3">
                                                                                        <div class="form-check">
                                                                                            <input class="form-check-input" type="radio" name="plan" onchange="networkprovider('${plan['variation_code']}')" value="${plan['variation_code']}|${plan['variation_amount']}" id="flexradio${plan['variation_code']}" />
                ...
                <div class="form-group">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="decoder" id="decoder"
                        class="form-control form-control-lg form-control-solid" />
                </div>
                <div class="form-group" id="profilecodediv" hidden>
                    <label class="form-label mb-3"> <a id="profilecode"></a> <?php echo app('translator')->get('Profilecode'); ?></label>
                    <!--end::Label-->
                    <!--begin::Input-->
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PhpstormProjects\mobileltechng\resources\mobileapp/templates/basic/user/bills/education/education_buy.blade.php ENDPATH**/ ?>