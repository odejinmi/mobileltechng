      ...
      <div class="row gy-3">
        <div class="col-3">
          <a href="<?php echo e(route('user.buy.local.utility')); ?>">
            ...
            <h5 class="mt-2 text-center dark-text">Utility</h5>
          </a>
        </div> 
        <div class="col-3">
        ...
        <?php endif; ?>
        <div class="col-3">
          <a href="#soon" data-bs-toggle="modal">
            <div class="service-box">
              <i class="iconsax categories-icon" data-feather="smile"></i>
            </div>
            <h5 class="mt-2 text-center dark-text">Betting</h5>
          </a>
        </div>
        <div class="col-3">
          <a href="#soon"  data-bs-toggle="modal">
    ...
    <div class="custom-container">
      ...
      <div class="row gy-3">
        ...
        <div class="alert alert-danger" role="alert">
            Sorry,Transaction Not Available
        </div>
        <?php endif; ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/core/resources/mobileapp/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>