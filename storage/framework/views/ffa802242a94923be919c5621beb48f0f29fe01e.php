        ...
        <form class="auth-form" action="<?php echo e(route('user.crypto.buy.confirm.manual')); ?>" method="POST" enctype="multipart/form-data">
         ...
         <div class="custom-container">
             ...
             <div class="upload-image rounded-image">
                 <input class="form-control upload-file" required type="file" name="proof" accept=".png, .jpg, .jpeg"  id="proof">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/assets/crypto/buycrypto/buy.blade.php ENDPATH**/ ?>