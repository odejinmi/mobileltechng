      ...
      <div class="modal-body">
        <ul class="details-list">
          <li>
            ...
            <h3 class="fw-normal light-text"><label class='badge <?php if($deposit->status == 'success'): ?> bg-success  <?php else: ?>  bg-danger <?php endif; ?>'><?php echo $deposit->status ?></label></h3>
          </li>
          <li>
          ...
          <li>
            ...
            <h3 class="fw-normal light-text"><?php echo e(__($deposit->val_1)); ?></h3>
          </li> 
          <li>
...
<a href="<?php echo e(route('user.fund.betting.wallet')); ?>" class="back-btn">
    <i class="icon" data-feather="x"></i>
  </a>
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/bills/betting/betting_log.blade.php ENDPATH**/ ?>