            ...
            <form class="auth-form p-0" method="post">
                ...
                <div class="form-group">
                    <label for="amount" class="form-label">
                        <?php echo app('translator')->get('Select Plan'); ?></label>
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/bills/internetsme/internet_buy_TECHHUB.blade.php ENDPATH**/ ?>