    ...
    <div class="swiper banner">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="#">
            <img class="img-fluid banner-img" src="<?php echo e(asset($activeTemplateTrue . 'mobile/images/banner/staking.jpeg')); ?>" alt="banner1" />
          </a>
        </div>

        <div class="swiper-slide">
          <a href="#">
            <img class="img-fluid banner-img" src="<?php echo e(asset($activeTemplateTrue . 'mobile/images/banner/7148456-ai.png')); ?>" style="height:100%;" alt="banner2" />
          </a>
        </div>
      </div>
    </div>
              ...
              <div class="transaction-details">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <h5 class="success-colors"  ><li>
                    ...
                    $<?php echo e(@number_format($wallet->usd,2) ?? '0.00'); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/wallet/index.blade.php ENDPATH**/ ?>