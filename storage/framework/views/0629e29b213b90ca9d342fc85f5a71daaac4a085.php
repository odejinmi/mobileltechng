          ...
          <a href="#transaction-detail<?php echo e($deposit->id); ?>" data-bs-toggle="modal" class="d-flex gap-3">
            ...
            <div class="transaction-details">
              ...
              <div class="d-flex justify-content-between">
                <h5 class="light-text"><?php echo e($deposit->val_2); ?></h5>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title">Subscription Detail</h2>
      </div>
      <div class="modal-body">
        <ul class="details-list">
          ...
          <li>
            ...
            <h3 class="fw-normal light-text"><?php echo e(__($deposit->val_2)); ?></h3>
          </li> 
          <li>
            <h3 class="fw-normal dark-text">Network</h3>
            <h3 class="fw-normal light-text"><?php echo e(@$deposit->product_name); ?></h3>
          </li>  
          <li>
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/bills/internetsme/internet_log.blade.php ENDPATH**/ ?>