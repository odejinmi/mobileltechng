<?php $__env->startSection('panel'); ?> 
            ...
            <div class="currency-transfer">
                <form class="auth-form crypto-form" id="invoicedetails">
                    <div class="form-group">
                        <label for="inputassets" class="form-label mb-2">Buy Crypto</label>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li
                                            onclick="getrate('<?php echo e($data->buy_rate); ?>','<?php echo e($data->name); ?>','<?php echo e($data->id); ?>')">
                        ...
                        <center>
                            <ul class="nav nav-pills tab-style3 w-100 mt-3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item w-25"  onclick="setamount(1000)" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                                        type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">$1000</button>
                                </li>
                                <li class="nav-item w-25" onclick="setamount(2000)" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                                        type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">$2000</button>
                                </li>
                            </ul>
  ...
  <section class="pay-money section-b-space" id="step2">
    <div class="custom-container">
        <form class="auth-form" action="<?php echo e(route('user.crypto.buy.confirm.manual')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>                                          
         <div class="custom-container">
             <div class="profile-pic">
             <img class="img-fluid img" src="<?php echo e(asset('assets/assets/dist/images/backgrounds/2.png')); ?>" alt="p3" />
             </div>
             <h3 class="person-name"><?php echo app('translator')->get('Please make payment to the account below'); ?></h3>
             <h5 class="upi-id" id="accountdetails"></h5>
             
             <div class="form-group">
             <div class="form-input mt-3">
                 <input type="text" class="form-control reason" name="walletaddress" id="walletaddress" required="" placeholder="Wallet Address" />
             </div>
             </div>
             <h3 class="info-id border-0 pb-0">Please enter your wallet address above.</h3>
             <input id="trxnumber" name="trx" hidden>


             <div class="form-group">
             <div class="upload-image rounded-image">
                 <input class="form-control upload-file" required type="file" name="proof" id="proof">
      ...
      .then(result => {
         ...
         if (resp.ok == true) { 
            if (resp.ok != false && resp.auto != true) {
                $("#step1").hide()
                $("#step2").show()
                document.getElementById('button').innerHTML = `I Paid ${resp.fiat}<?php echo e($general->cur_text); ?>`;
                document.getElementById("trxnumber").value = `${resp.trx}`;
                document.getElementById("accountdetails").innerHTML = `${resp.coin.account_details}`;
            }
         }
...
<a href="<?php echo e(route('user.crypto.buy.log')); ?>" class="back-btn">
    <i class="icon" data-feather="grid"></i>
  </a>
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/core/resources/mobileapp/templates/basic/user/assets/crypto/buycrypto/buy.blade.php ENDPATH**/ ?>