  ...
  <section>
    <div class="custom-container">
      ...
      <div class="row gy-3">
        ...
        <div class="col-3">
          <a href="<?php echo e(route('user.fund.betting.wallet')); ?>">
            <div class="service-box">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>