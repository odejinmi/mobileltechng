          ...
          <a href="#transaction-detail<?php echo e($deposit->id); ?>" data-bs-toggle="modal" class="d-flex gap-3">
            ...
            <div class="transaction-details">
              <div class="transaction-name">
                ...
                <h3 class="success-color"> <?php echo e(__($general->cur_sym)); ?><?php echo e(showAmount($deposit->payment)); ?><span></span></h3>
              </div>
      ...
      <div class="modal-body">
        <ul class="details-list">
          <li>
            ...
            <h3 class="fw-normal light-text"><label class='badge bg-success'> <?php echo e($deposit->status); ?></label></h3>
          </li>
          <li>
          ...
          <li>
            ...
            <h3 class="fw-normal light-text"><?php echo e(__($deposit->deposit_code)); ?></h3>
          </li> 
          <li>
            <h3 class="fw-normal dark-text">Company</h3>
            <h3 class="fw-normal light-text"><?php echo e(@$deposit->product_logo); ?></h3>
          </li>  
          <li>
            <h3 class="fw-normal dark-text">Customer</h3>
            <h3 class="fw-normal light-text"><?php echo e(@$deposit->val_1); ?></h3>
          </li>  
          <li>
            <h3 class="fw-normal dark-text">Number</h3>
            <h3 class="fw-normal light-text"><?php echo e(@$deposit->val_2); ?></h3>
          </li>  
          <li class="amount">
            <h3 class="fw-normal dark-text">Amount</h3>
            <h3 class="fw-semibold error-color"><?php echo e(__($general->cur_text)); ?> <?php echo e(showAmount($deposit->payment / $deposit->quantity)); ?></h3>
          </li>
        </ul>
      </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/mobile.ltechng.co/mobile-app/resources/mobileapp/templates/basic/user/bills/utilityLocal/utility_log.blade.php ENDPATH**/ ?>