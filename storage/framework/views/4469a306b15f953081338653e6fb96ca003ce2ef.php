...
<section class="section-b-space">
    <div class="custom-container">
        ...
        <div class="form-group">
          ...
          <select type="text"  onchange="fixeamount(this)" class="form-control form-select <?php $__errorArgs = ['network'];
...
unset($__errorArgs, $__bag); ?>" id="network"
        ...
        <div class="form-group">
          ...
          <div class="form-input">
            <input type="number" id="amount"  onkeyup="fixeamount(this)"  class="form-control amount <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/core/resources/mobileapp/templates/basic/user/bills/airtime2cash/create.blade.php ENDPATH**/ ?>