          ...
          <div class="swiper banner">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <a href="#">
                  <img class="img-fluid banner-img" src="<?php echo e(asset($activeTemplateTrue . 'mobile/images/banner/insurance1.png')); ?>" alt="banner1" />
                </a>
              </div>
    
              <div class="swiper-slide">
                <a href="#">
                  <img class="img-fluid banner-img" src="<?php echo e(asset($activeTemplateTrue . 'mobile/images/banner/insurance2.png')); ?>" alt="banner2" />
                </a>
              </div>
            </div>
          </div>
                                        ...
                                        success: function(data) {
                                            if (data.status == 'true') {
                                                ...
                                                <div class="add-content">
                                                    ...
                                                    <h6 class="mt-2 light-text"><?php echo e($general->cur_sym); ?>${plan['variation_amount']}</h6>
                                                    </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('user.insurance.history')); ?>" class="back-btn">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/bills/insurance/insurance_buy.blade.php ENDPATH**/ ?>