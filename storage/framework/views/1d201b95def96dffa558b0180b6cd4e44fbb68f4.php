...
<section class="section-b-space">
    <div class="custom-container"> 
      ...
      <div class="row gy-3">
        <?php $__empty_1 = true; $__currentLoopData = @$transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-12">
            ...
            <a href="#transaction-detail<?php echo e($deposit->id); ?>" data-bs-toggle="modal" class="d-flex gap-3">
              ...
              <div class="transaction-details">
                <div class="transaction-name">
                  ...
                  <h3 class="success-color"> <?php echo e(__($general->cur_sym)); ?><?php echo e(showAmount($deposit->amount)); ?><span></span></h3>
                </div>
                <div class="d-flex justify-content-between">
                  <h5 class="light-text"><?php echo e($deposit->remark); ?></h5>
        ...
        <div class="modal-body">
          <ul class="details-list">
            ...
            <li>
              ...
              <h3 class="fw-normal light-text"><?php echo e(@$deposit->val_1->bank); ?></h3>
            </li> 
            <li>
              <h3 class="fw-normal dark-text">Name</h3>
              <h3 class="fw-normal light-text"><?php echo e(@$deposit->val_1->account_name); ?></h3>
            </li> 
            <li>
              <h3 class="fw-normal dark-text">Nuban</h3>
              <h3 class="fw-normal light-text"><?php echo e(@$deposit->val_1->account_number); ?></h3>
            </li> 
            <li>
              <h3 class="fw-normal dark-text">Narration</h3>
              <h3 class="fw-normal light-text"><?php echo e(__($deposit->remark)); ?></h3>
            </li> 
            <li class="amount">
...
<a href="<?php echo e(route('user.bank.transfer.start')); ?>" class="back-btn">
    <i class="icon" data-feather="x"></i>
  </a>
<?php $__env->stopPush(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/core/resources/mobileapp/templates/basic/user/bank/history.blade.php ENDPATH**/ ?>