    ...
    <div class="custom-container">
      ...
      <div class="form-group">
        ...
        <div class="form-input">
          <textarea class="form-control" id="inputmessage" name="purpose" value="<?php echo e(old('purpose')); ?>" rows="3" placeholder="Write here"></textarea>
        </div>
      </div>
...
<a href="<?php echo e(route('user.invoice.history')); ?>" class="back-btn">
  <i class="icon" data-feather="printer"></i>
</a>
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/vendor/invoice/create.blade.php ENDPATH**/ ?>