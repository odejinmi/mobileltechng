...
<div class="auth-header">
  ...
  <!-- login section start -->
  <form class="auth-form" method="POST" action="<?php echo e(route('user.verify.email')); ?>">
    <?php echo csrf_field(); ?> 
    <div class="custom-container">
      ...
      <h4 class="signup">Haven’t received yet ?<a href="<?php echo e(route('user.send.verify.code', 'email')); ?>"> Resend it </a></h4>
    </div>
  </form>
  <!-- login section start -->
...
<?php echo $__env->make($activeTemplate . 'layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/auth/authorization/email.blade.php ENDPATH**/ ?>