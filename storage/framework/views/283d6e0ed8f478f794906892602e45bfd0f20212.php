<?php $__env->startSection('content'); ?>
    ...
    <form class="auth-form" method="POST" id="login" action="<?php echo e(route('user.login')); ?>">
        ...
        <div class="custom-container">
            ...
            <button type="button" id="button" class="btn theme-btn w-100" onclick="loadbutton()">Sign In</button>
            <div id="loader"></div>
            <div class="division">
                <span>OR</span>
            </div>
            ...
            <a href="<?php echo e(route('user.register')); ?>" target="" class="btn gray-btn mt-3"> <img class="img-fluid google"
                    src="<?php echo e(asset($activeTemplateTrue . 'mobile/images/svg/google.svg')); ?>" alt="google" /> Continue with
                Email</a>
...
<?php echo $__env->make($activeTemplate . 'layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>