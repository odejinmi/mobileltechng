  ...
  <section class="section-b-space">
    <div class="custom-container">
      ...
      <ul class="profile-list">
        ...
        <?php if(Auth::user()->vendor > 0): ?>
        <li>
          <a href="<?php echo e(route('user.change.terminalpassword')); ?>" class="profile-box">
            <div class="profile-img">
...
<?php echo $__env->make($activeTemplate . 'layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypointmobile/mobile-app/resources/mobileapp/templates/basic/user/profile_setting.blade.php ENDPATH**/ ?>