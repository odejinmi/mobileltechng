...
{
    $jsonUrl = resource_path('mobileapp/') . str_replace('.', '/', activeTemplate()) . 'sections.json';
...
function notify($user, $templateName, $shortCodes = null, $sendVia = null, $createLog = true, $smstype = "bc")
{
    $general = gs();
    $globalShortCodes = [
