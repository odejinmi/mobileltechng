...
class EscrowController extends Controller {
    ...
    public function welcome($type = null) {
        $pageTitle = 'My Escrow'; 
        return view($this->activeTemplate . 'user.vendor.escrow.welcome', compact('pageTitle'));
    }
    ...
    public function index($type = null) {
        ...
        return view($this->activeTemplate . 'user.vendor.escrow.index', compact('pageTitle', 'escrows'));
    }

    public function stepOne() {
        $pageTitle = "New Escrow - Step One";
        return view($this->activeTemplate . 'user.vendor.escrow.step_one', compact('pageTitle'));
    }
    ...
    public function stepTwo() {
        ...
        return view($this->activeTemplate . 'user.vendor.escrow.step_two', compact('pageTitle', 'escrowInfo'));
    }
    ...
    public function details($id) {
        ...
        return view($this->activeTemplate . 'user.vendor.escrow.details', compact('pageTitle', 'escrow', 'conversation', 'messages'));
    }
    ...
    public function getMessages(Request $request) {
        ...
        return view($this->activeTemplate . 'user.vendor.escrow.message', compact('messages', 'escrow'));
    }
